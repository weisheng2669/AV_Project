...
Java_com_example_av_1project_entity_FFmpegHandler_init(JNIEnv *jniEnv, jobject instance, jstring url) {
    // TODO: implement init()
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_av_1project_entity_FFmpegHandler_close(JNIEnv *env, jobject thiz) {
